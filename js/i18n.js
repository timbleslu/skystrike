...
const I18N = {
  EN: {
    ...
    'op.ironVeil.l1.obj': 'Photograph all ZMSF beach fortifications. Weapons tight — do not fire unless fired upon.',
    ...
    'op.ironVeil.l3.obj': 'Neutralize the ZMSF radar emitter. Egress undetected — stay off their scopes.',
    ...
    'op.midnightMeridian.l1.obj': 'Destroy the forward radar emitters. Zero radio emissions — exit undetected.',
    ...
    'op.midnightMeridian.l2.obj': 'Map all SAM battery positions. Do not engage unless survival requires it.',
    ...
    'op.sunfireHorizon.l3.obj': 'Capture the terminal targeting solution. Survive — you carry the only sensor pod.',
    ...
    'op.sunfireHorizon.l6.obj': 'Disable the outer radar nodes by hand. Egress before the shift rotates — do not trip the failsafe.',
  ...
  ZH: {
    ...
    'op.ironVeil.l1.obj': '拍摄全部朱良滩头工事。武器禁射——非受击不得开火。',
    ...
    'op.ironVeil.l3.obj': '摧毁朱良雷达发射源。不被发现地撤离——别上他们的屏幕。',
    ...
    'op.midnightMeridian.l1.obj': '摧毁前沿雷达发射机。零无线电辐射——不被发现地撤离。',
    ...
    'op.midnightMeridian.l2.obj': '标定全部防空导弹阵地。非生存所迫不得交战。',
    ...
    'op.sunfireHorizon.l3.obj': '获取末段瞄准解算。务必生还——你携带唯一的传感器吊舱。',
    ...
    'op.sunfireHorizon.l6.obj': '亲手瘫痪外层雷达节点。趁换班前撤离——别触发故障保险。',
