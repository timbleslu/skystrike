...
const OPERATIONS = [
  {
    ...
    levels: [
      ...
      { id: 'blindspot',   coords: { x: 68, y: 76 }, nameKey: 'op.ironVeil.l3.name', type: 'STEALTH',   objectives: [{ type: 'STEALTH', wp: 1 }, { type: 'STRIKE', spawn: { ground: true } }], loreKey: 'op.ironVeil.l3.lore', objectivesKey: 'op.ironVeil.l3.obj', enemyIntelKey: 'op.ironVeil.l3.intel', starUnique: { type: 'fastClear', n: 150 }, waves: 1, spawn: { fighters: 2, aces: 0, bombers: 0, ground: false, weather: 'fog', tod: 2, hostileAce: false } },
      { id: 'tripwire',    coords: { x: 30, y: 26 }, nameKey: 'op.ironVeil.l4.name', type: 'INTERCEPT', loreKey: 'op.ironVeil.l4.lore', objectivesKey: 'op.ironVeil.l4.obj', enemyIntelKey: 'op.ironVeil.l4.intel', starUnique: { type: 'noDamage' }, waves: 3, spawn: { fighters: 3, aces: 0, bombers: 2, ground: false, weather: 'fog', tod: 1, hostileAce: true } },
      { id: 'ironShield',  coords: { x: 14, y: 50 }, nameKey: 'op.ironVeil.l5.name', type: 'DEFEND',    loreKey: 'op.ironVeil.l5.lore', objectivesKey: 'op.ironVeil.l5.obj', enemyIntelKey: 'op.ironVeil.l5.intel', starUnique: { type: 'flawless' }, waves: 3, spawn: { fighters: 3, aces: 1, bombers: 1, ground: false, weather: 'storm', tod: 1, hostileAce: true } },
      { id: 'lifeline',    coords: { x: 80, y: 30 }, nameKey: 'op.ironVeil.l6.name', type: 'ESCORT',    loreKey: 'op.ironVeil.l6.lore', objectivesKey: 'op.ironVeil.l6.obj', enemyIntelKey: 'op.ironVeil.l6.intel', starUnique: { type: 'noDamage' }, waves: 4, spawn: { fighters: 3, aces: 1, bombers: 0, ground: false, weather: 'clear', tod: 0, hostileAce: true } },
      { id: 'hammerFall',  coords: { x: 56, y: 54 }, nameKey: 'op.ironVeil.l7.name', type: 'STRIKE',    loreKey: 'op.ironVeil.l7.lore', objectivesKey: 'op.ironVeil.l7.obj', enemyIntelKey: 'op.ironVeil.l7.intel', starUnique: { type: 'noFlares' }, waves: 4, spawn: { fighters: 3, aces: 0, bombers: 0, ground: true, weather: 'storm', tod: 0, hostileAce: true } },
      { id: 'warlord',     coords: { x: 62, y: 38 }, nameKey: 'op.ironVeil.l8.name', type: 'FINAL',     loreKey: 'op.ironVeil.l8.lore', objectivesKey: 'op.ironVeil.l8.obj', enemyIntelKey: 'op.ironVeil.l8.intel', starUnique: { type: 'killsN', n: 6 }, waves: 1, isBoss: true, bossApproachWave: true, spawn: { fighters: 4, aces: 2, bombers: 0, ground: false, weather: 'storm', tod: 2, hostileAce: false },
  ...
  },
  {
    ...
    levels: [
      ...
      { id: 'coldIron',     coords: { x: 74, y: 62 }, nameKey: 'op.midnightMeridian.l3.name', type: 'FURBALL',   loreKey: 'op.midnightMeridian.l3.lore', objectivesKey: 'op.midnightMeridian.l3.obj', enemyIntelKey: 'op.midnightMeridian.l3.intel', starUnique: { type: 'accuracy', n: 50 }, waves: 3, spawn: { fighters: 4, aces: 0, bombers: 0, ground: false, weather: 'storm', tod: 1, hostileAce: true } },
      { id: 'ironCurtain',  coords: { x: 60, y: 24 }, nameKey: 'op.midnightMeridian.l4.name', type: 'INTERCEPT', loreKey: 'op.midnightMeridian.l4.lore', objectivesKey: 'op.midnightMeridian.l4.obj', enemyIntelKey: 'op.midnightMeridian.l4.intel', starUnique: { type: 'fastClear', n: 150 }, waves: 3, spawn: { fighters: 3, aces: 0, bombers: 3, ground: false, weather: 'fog',   tod: 1, hostileAce: true } },
      { id: 'lastLine',     coords: { x: 16, y: 56 }, nameKey: 'op.midnightMeridian.l5.name', type: 'DEFEND',    loreKey: 'op.midnightMeridian.l5.lore', objectivesKey: 'op.midnightMeridian.l5.obj', enemyIntelKey: 'op.midnightMeridian.l5.intel', starUnique: { type: 'killsN', n: 10 }, waves: 4, spawn: { fighters: 3, aces: 1, bombers: 2, ground: false, weather: 'storm', tod: 2, hostileAce: true } },
      { id: 'longReach',    coords: { x: 46, y: 46 }, nameKey: 'op.midnightMeridian.l6.name', type: 'STRIKE',    loreKey: 'op.midnightMeridian.l6.lore', objectivesKey: 'op.midnightMeridian.l6.obj', enemyIntelKey: 'op.midnightMeridian.l6.intel', starUnique: { type: 'fastClear', n: 140 }, waves: 4, spawn: { fighters: 3, aces: 1, bombers: 0, ground: true,  weather: 'storm', tod: 1, hostileAce: true } },
      { id: 'extraction',   coords: { x: 24, y: 30 }, nameKey: 'op.midnightMeridian.l7.name', type: 'ESCORT',    loreKey: 'op.midnightMeridian.l7.lore', objectivesKey: 'op.midnightMeridian.l7.obj', enemyIntelKey: 'op.midnightMeridian.l7.intel', starUnique: { type: 'flawless' }, waves: 4, spawn: { fighters: 4, aces: 1, bombers: 0, ground: false, weather: 'storm', tod: 2, hostileAce: true } },
      { id: 'glacier',      coords: { x: 50, y: 14 }, nameKey: 'op.midnightMeridian.l8.name', type: 'FINAL',     loreKey: 'op.midnightMeridian.l8.lore', objectivesKey: 'op.midnightMeridian.l8.obj', enemyIntelKey: 'op.midnightMeridian.l8.intel', starUnique: { type: 'accuracy', n: 50 }, waves: 1, isBoss: true, bossApproachWave: true, spawn: { fighters: 4, aces: 2, bombers: 0, ground: false, weather: 'storm', tod: 1, hostileAce: false },
  ...
  },
  {
    ...
    levels: [
      ...
      { id: 'deadReckoning', coords: { x: 50, y: 64 }, nameKey: 'op.sunfireHorizon.l3.name', type: 'RECON',     objectives: [{ type: 'RECON', wp: 2 }, { type: 'SWEEP', spawn: { fighters: 3 } }, { type: 'DEFEND', spawn: { bombers: 2 } }], loreKey: 'op.sunfireHorizon.l3.lore', objectivesKey: 'op.sunfireHorizon.l3.obj', enemyIntelKey: 'op.sunfireHorizon.l3.intel', starUnique: { type: 'noDamage' }, waves: 1, spawn: { fighters: 2, aces: 0, bombers: 0, ground: false, weather: 'clear', tod: 1, hostileAce: false } },
      { id: 'shieldwall',    coords: { x: 14, y: 70 }, nameKey: 'op.sunfireHorizon.l4.name', type: 'DEFEND',    loreKey: 'op.sunfireHorizon.l4.lore', objectivesKey: 'op.sunfireHorizon.l4.obj', enemyIntelKey: 'op.sunfireHorizon.l4.intel', starUnique: { type: 'noDamage' }, waves: 3, spawn: { fighters: 3, aces: 1, bombers: 2, ground: true,  weather: 'storm', tod: 0, hostileAce: true } },
      { id: 'lifeguard',     coords: { x: 20, y: 44 }, nameKey: 'op.sunfireHorizon.l5.name', type: 'ESCORT',    loreKey: 'op.sunfireHorizon.l5.lore', objectivesKey: 'op.sunfireHorizon.l5.obj', enemyIntelKey: 'op.sunfireHorizon.l5.intel', starUnique: { type: 'fastClear', n: 160 }, waves: 3, spawn: { fighters: 3, aces: 1, bombers: 0, ground: false, weather: 'clear', tod: 1, hostileAce: true } },
      { id: 'silentEntry',   coords: { x: 46, y: 48 }, nameKey: 'op.sunfireHorizon.l6.name', type: 'STEALTH',   objectives: [{ type: 'STEALTH', wp: 1 }, { type: 'STRIKE', spawn: { ground: true } }, { type: 'ESCORT', spawn: { fighters: 3 } }], loreKey: 'op.sunfireHorizon.l6.lore', objectivesKey: 'op.sunfireHorizon.l6.obj', enemyIntelKey: 'op.sunfireHorizon.l6.intel', starUnique: { type: 'fastClear', n: 170 }, waves: 1, spawn: { fighters: 3, aces: 0, bombers: 0, ground: true,  weather: 'fog',   tod: 2, hostileAce: false } },
      { id: 'firstVolley',   coords: { x: 70, y: 38 }, nameKey: 'op.sunfireHorizon.l7.name', type: 'STRIKE',    loreKey: 'op.sunfireHorizon.l7.lore', objectivesKey: 'op.sunfireHorizon.l7.obj', enemyIntelKey: 'op.sunfireHorizon.l7.intel', starUnique: { type: 'gunOnly' }, waves: 4, spawn: { fighters: 3, aces: 1, bombers: 0, ground: true,  weather: 'storm', tod: 1, hostileAce: true } },
      { id: 'secondSun',     coords: { x: 40, y: 26 }, nameKey: 'op.sunfireHorizon.l8.name', type: 'STRIKE',    loreKey: 'op.sunfireHorizon.l8.lore', objectivesKey: 'op.sunfireHorizon.l8.obj', enemyIntelKey: 'op.sunfireHorizon.l8.intel', starUnique: { type: 'killsN', n: 8 }, waves: 4, spawn: { fighters: 4, aces: 1, bombers: 0, ground: true,  weather: 'storm', tod: 2, hostileAce: true } },
      { id: 'corsair',       coords: { x: 66, y: 18 }, nameKey: 'op.sunfireHorizon.l9.name', type: 'FINAL',     loreKey: 'op.sunfireHorizon.l9.lore', objectivesKey: 'op.sunfireHorizon.l9.obj', enemyIntelKey: 'op.sunfireHorizon.l9.intel', starUnique: { type: 'fastClear', n: 200 }, waves: 1, isBoss: true, bossApproachWave: true, spawn: { fighters: 4, aces: 2, bombers: 0, ground: false, weather: 'storm', tod: 2, hostileAce: false },
