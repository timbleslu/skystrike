...
const OPERATIONS = [
  {
    ...
    levels: [
      ...
      { id: 'blindspot',   coords: { x: 68, y: 76 }, nameKey: 'op.ironVeil.l3.name', type: 'STEALTH',   objectives: [{ type: 'STEALTH', wp: 1 }, { type: 'STRIKE', spawn: { ground: true } }], loreKey: 'op.ironVeil.l3.lore', objectivesKey: 'op.ironVeil.l3.obj', enemyIntelKey: 'op.ironVeil.l3.intel', waves: 1, stars: [{ type: 'noDamage' }, { type: 'objective' }, { type: 'accuracy', n: 60 }], spawn: { fighters: 2, aces: 0, bombers: 0, ground: false, weather: 'fog', tod: 2, hostileAce: false } },
      ...
      { id: 'ironShield',  coords: { x: 14, y: 50 }, nameKey: 'op.ironVeil.l5.name', type: 'DEFEND',    loreKey: 'op.ironVeil.l5.lore', objectivesKey: 'op.ironVeil.l5.obj', enemyIntelKey: 'op.ironVeil.l5.intel', waves: 3, stars: [{ type: 'flawless' }, { type: 'clean' }, { type: 'kills' }], spawn: { fighters: 3, aces: 1, bombers: 1, ground: false, weather: 'storm', tod: 1, hostileAce: true } },
      ...
      { id: 'warlord',     coords: { x: 62, y: 38 }, nameKey: 'op.ironVeil.l8.name', type: 'FINAL',     loreKey: 'op.ironVeil.l8.lore', objectivesKey: 'op.ironVeil.l8.obj', enemyIntelKey: 'op.ironVeil.l8.intel', waves: 1, isBoss: true, bossApproachWave: true, stars: [{ type: 'noDamage' }, { type: 'objective' }, { type: 'kills' }], spawn: { fighters: 4, aces: 2, bombers: 0, ground: false, weather: 'storm', tod: 2, hostileAce: false },
