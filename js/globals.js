...
let hudScale = 1.0;               // HUD/readout size multiplier (Settings → HUD size dropdown; in-flight HUD only)
let uiScale = 1.0;                // Menu-screen size multiplier (Settings → UI size dropdown; zooms every menu/overlay screen)
