/* Vendored Three.js r159 DRACOLoader adapted to a browser GLOBAL (no ES modules).
...
(function () {
const { BufferAttribute, BufferGeometry, Color, FileLoader, Loader, LinearSRGBColorSpace, SRGBColorSpace } = THREE;
